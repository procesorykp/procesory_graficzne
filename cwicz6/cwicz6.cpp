...
float location[] = {1.0f, 1.0f, 0.0f}, target[] = {0.0f, 0.0f, 0.0f}, up_dir[] = {0.0f, 0.0f, 1.0f}, camera_matrix[16], intensity_ambient_component[] = {0.05f, 0.05f, 0.05f}, swiatlo_position_eye_space[3];
CStopWatch timer;
...
void change_size(int w, int h) {
   view_frustum.SetPerspective(60.0f, (float)w / h, 1.0f, 100.0f);
   glViewport(0, 0, w, h);
}
...
void setup_rc() {
   ...
   shader_swiatlo = gltLoadShaderPairWithAttributes("phong_shader.vp", "phong_shader.fp", 3, GLT_ATTRIBUTE_VERTEX, "vPosition", GLT_ATTRIBUTE_NORMAL, "vertex_normal");
   ShaderColor = gltLoadShaderPairWithAttributes("pass_thru_shader.vp", "pass_thru_shader.fp", 2, GLT_ATTRIBUTE_VERTEX, "vPosition", GLT_ATTRIBUTE_COLOR, "vertex_color");
   ...
   swiatlo_0.set_position(0.0f, 0.0f, 1.0f);
   swiatlo_0.set_intensity_diffuse(0.5f, 1.0f, 0.5f);
   swiatlo_0.set_intensity_specular(0.5f, 0.913f, 0.5f);
...
void rysuj_swiatlo() {
   ...
   fill_array_3(A, 3.0f, -3.0f, 0.0f);
   fill_array_3(B, -3.0f, -3.0f, 0.0f);
   fill_array_3(C, 3.0f, 3.0f, 0.0f);
   draw_trinagle_face_no_normal(A, B, C, 1.0f, 1.0f, 1.0f);
   fill_array_3(A, -3.0f, 3.0f, 0.0f);
   fill_array_3(B, 3.0f, 3.0f, 0.0f);
   fill_array_3(C, -3.0f, -3.0f, 0.0f);
   draw_trinagle_face_no_normal(A, B, C, 1.0f, 1.0f, 1.0f);
...
void render_scene(void) {
   ...
   location[0] = -5.0f * cos(angle / 2.0f);
   location[1] = -5.0f * sin(angle / 2.0f);
   location[2] = 8.0f;
   swiatlo_0.position[0] = 5.0f * cos(-angle);
   swiatlo_0.position[1] = 5.0f * sin(-angle);
   swiatlo_0.position[2] = 3.0f;
   ...
   m3dTransformVector3(swiatlo_position_eye_space, swiatlo_0.position, camera_matrix);
   glUniform3fv(swiatlo_0_position_location, 1, swiatlo_position_eye_space);
